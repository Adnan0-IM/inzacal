...
import inzacalLogo from '/logo_clean.svg'
    ...
    return (
        <footer id='contact' className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <img src={inzacalLogo} width={150} height={500} alt="inzacal logo" />
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Inzacal, All rights reserved</span>
            </div>
        </footer>
    )
}
